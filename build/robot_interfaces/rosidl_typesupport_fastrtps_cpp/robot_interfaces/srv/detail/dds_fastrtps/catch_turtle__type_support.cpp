...
#include "robot_interfaces/srv/detail/catch_turtle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_interfaces::srv::CatchTurtle_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_interfaces::srv::CatchTurtle_Request & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
...
{
  auto typed_message =
    static_cast<const robot_interfaces::srv::CatchTurtle_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_interfaces::srv::CatchTurtle_Request *>(
    untyped_ros_message);
...
{
  return &robot_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, srv, CatchTurtle_Request)() {
  return &robot_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_robot_interfaces
cdr_serialize(
  const robot_interfaces::srv::CatchTurtle_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: sucess
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_interfaces::srv::CatchTurtle_Response & ros_message)
{
  // Member: sucess
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const robot_interfaces::srv::CatchTurtle_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robot_interfaces::srv::CatchTurtle_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &robot_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, srv, CatchTurtle_Response)() {
  return &robot_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Response__handle;
}
...
{
  return &robot_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, srv, CatchTurtle)() {
  return &robot_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle__handle;
}
