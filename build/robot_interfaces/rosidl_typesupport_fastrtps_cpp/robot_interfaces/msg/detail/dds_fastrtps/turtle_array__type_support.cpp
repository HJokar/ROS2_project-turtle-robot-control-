...
#include "robot_interfaces/msg/detail/turtle_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const robot_interfaces::msg::Turtle &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  robot_interfaces::msg::Turtle &);
...
cdr_serialize(
  const robot_interfaces::msg::TurtleArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_interfaces::msg::TurtleArray & ros_message)
{
  // Member: turtles
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: turtles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        robot_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Turtle(
...
{
  auto typed_message =
    static_cast<const robot_interfaces::msg::TurtleArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_interfaces::msg::TurtleArray *>(
    untyped_ros_message);
...
{
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_TurtleArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, msg, TurtleArray)() {
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_TurtleArray__handle;
}
